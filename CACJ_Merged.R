...
ggplot(emmeans_data, aes(x = x, y = predicted, color = group)) +
  ...
  labs(title = "Figure 8. Interaction Plot Between Court Types by Population Area", x = "Court Type",
...
ggplot(ggp2,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 7.Effect of Proportion of Unemployed When Entering Program on Proportion of \nParticipants Exit Program With Full Time Job",
...
ggplot(ggp3,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 9. Interaction Plot of  Population Area and Proportion \nof Participants Exit Program With Full Time Job ",
       x="Proportion of Full time When Exiting",
       y="Mean Proportion of Successes",
...
ggplot(ggp4,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 10. Interaction Plot of Population Area and Proportion of Participants with Collge Degrees",
...
ggplot(ggp1, mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 11. Interaction Plot of Average Age of Participants and Court Type",
...
ggplot(ggp2,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 12. Interaction Plot of Average Duration Participant \nStayed in Program and Court Type",
...
ggplot(ggp3,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 13. Interaction Plot of Court Type and Proportion of \nParticipants Exiting Program With Part Time Job ",
...
ggplot(ggp4,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 14. Interaction Plot of Court Type and Proportion \nof Participants Exiting Program Unemployed ",
...
ggplot(ggp5,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 15. Effect of Average Age of Particiant in Program on \nProportion of Participants Exiting Program With Full Time Job",
...
ggplot(ggp6,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title= "Figure 16. Effect of Proportion of Unemployed When Entering \nProgram on Proportion of Participants with College Degrees" ,
...
ggplot(ggp7,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 17. Effect of Proportion of Unemployed When Exiting \nProgram on Proportion of Participants with College Degrees",
       x="Proportion of Participant with College Degrees",
       y="Mean Proportion of Successes",
...
ggplot(ggp8,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 18. Effect of Proportion of Unemployed Participants When \nEntering Program on Proportion of Participants Exiting Program Unemployed",
...
ggplot(ggp9,mapping=aes(x=x,y=predicted,color=group)) + 
  geom_line()  +
  labs(title="Figure 19. Effect of Proportion of Participant With Full-TIme Jobs When Exiting \nProgram on Proportion of Participants Exiting Program Unemployed",
       x="Proportion of Full time When Exiting",
       y="Mean Proportion of Successes",
       color="Proportion of \nParticipants Unemployed \nWhen Exiting Program")
